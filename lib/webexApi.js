...
module.exports = {
  uploadAnnouncementFiles: async function (data, fileName, webexToken, webexOrgId, webexSiteId = null) {
    ...
    if (webexSiteId) {
      fullUrl = urljoin(fullUrl, "locations", webexSiteId);
    }
  ...
  getAnnouncementFiles: async function (webexToken, webexOrgId, webexSiteId = null) {
    let headers = new Headers();
    headers.set("Authorization", `Bearer ${webexToken}`);
    ...
    if (webexSiteId) {
      url.searchParams.append("locationId", webexSiteId);
    }
  ...
  deleteAnnouncementFiles: async function (webexToken, webexOrgId, announcementId, webexSiteId = null) {
